      ...
      <div className="relative z-10 container mx-auto px-4 py-12 md:py-20 lg:py-32">
        <div className="max-w-3xl animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 mb-8 md:mb-12">
            <Button
              size="lg"
              className="bg-accent hover:bg-accent-hover text-white text-base sm:text-lg md:text-xl px-6 sm:px-8 py-5 sm:py-6 shadow-xl w-full sm:w-auto whitespace-nowrap font-bold"
            ...
            <Button
              size="lg"
              variant="outline"
              className="bg-white/10 text-white border-white/30 hover:bg-white/20 backdrop-blur-sm text-base sm:text-lg md:text-xl px-6 sm:px-8 py-5 sm:py-6 w-full sm:w-auto whitespace-nowrap font-bold"
              asChild
            >
