        ...
        <section className="relative overflow-hidden pt-10 pb-16 md:pt-20 md:pb-28 bg-gradient-to-r from-[#1e40af] to-[#10b981]">
            ...
            <div className="relative z-10 container mx-auto px-4 text-center">
                ...
                <h1 className="text-lg xs:text-xl sm:text-2xl md:text-4xl font-bold text-white mb-2 md:mb-3 tracking-wider flex items-end justify-center gap-1 sm:gap-2 whitespace-nowrap">
                    <span className="text-white text-2xl xs:text-3xl sm:text-4xl md:text-5xl font-black drop-shadow-xl">ネット証券</span>
                    <span className="text-white text-4xl xs:text-5xl sm:text-6xl md:text-7xl font-black drop-shadow-xl">10</span>
                    <span className="text-white text-2xl xs:text-3xl sm:text-4xl md:text-5xl font-black drop-shadow-xl">社</span>
                    徹底比較
                </h1>
