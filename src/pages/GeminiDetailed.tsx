...
const GeminiDetailed = () => {
  const features = [
    {
      title: "SOC1 Type 2およびSOC2 Type 2認証取得",
      description: "SOC1 Type 2およびSOC2 Type 2認証を取得しており、高いセキュリティ基準を満たしています。",
    ...
    {
      title: "ISO 27001およびSOC 2 Type 2認証",
      description: "ISO 27001およびSOC 2 Type 2認証を取得しており、国際的に認められたセキュリティ基準を満たしています。",
      icon: <Shield className="h-6 w-6" />
    },
    {
      title: "Winklevoss兄弟創業",
      description: "Winklevoss兄弟によって創業された取引所で、信頼性と実績があります。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "規制重視",
      description: "規制を重視しており、米国で厳格な規制を満たすセキュリティ体制を整えています。",
      icon: <Shield className="h-6 w-6" />
    },
    {
      title: "多様な暗号資産の取扱",
  ...
  const steps = [
    {
      step: "STEP1",
      title: "アカウント登録",
      description: "Gemini公式サイトで「個人アカウントに登録」をクリックし、名前、メールアドレス、パスワードを入力してください。登録確認メールが届くので、リンクをクリックして認証を完了します。"
    },
    {
      step: "STEP2",
      title: "本人確認（KYC）",
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="flex-grow">
        ...
        <section className="py-16 bg-gradient-to-b from-muted/30 to-background">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center">Geminiの特徴</h2>
        ...
        <section className="py-16 bg-gradient-to-b from-background to-muted/30">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center">Geminiの始め方｜簡単3ステップ</h2>
        ...
        <section className="py-16 bg-gradient-to-b from-primary/10 to-background">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center text-primary">こんな人にGeminiがおすすめ</h2>
