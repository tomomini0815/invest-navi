...
const KrakenDetailed = () => {
  const features = [
    {
      title: "ISO/IEC 27001:2013認証",
      description: "ISO/IEC 27001:2013認証を取得しており、国際的に認められたセキュリティ基準を満たしています。",
      icon: <Shield className="h-6 w-6" />
    },
    {
      title: "2011年創業の老舗取引所",
      description: "2011年から運営されている老舗取引所です。長年の実績と信頼があります。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "優れた顧客サポート",
      description: "優れた顧客サポートを提供しており、ユーザーの信頼を得ています。",
      icon: <Users className="h-6 w-6" />
    },
    {
      title: "取引量に応じた手数料割引",
      description: "取引量に応じて手数料が割引される仕組みを採用しています。頻繁に取引するユーザーにとってコスト効率が良いです。",
  ...
  const steps = [
    {
      step: "STEP1",
      title: "アカウント登録",
      description: "Kraken公式サイトで「アカウントを作成」をクリックし、名前、メールアドレス、パスワードを入力してください。登録確認メールが届くので、リンクをクリックして認証を完了します。"
    },
    {
      step: "STEP2",
      title: "本人確認（KYC）",
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="flex-grow">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <div className="mt-8">
              <Button asChild size="lg" className="px-8 py-6 text-lg hover:scale-105 transition-transform bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 shadow-lg">
                <a 
                  href="https://www.kraken.com/ja-jp" 
                  target="_blank" 
        ...
        <section className="py-16 bg-gradient-to-b from-muted/30 to-background">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center">Krakenの特徴</h2>
        ...
        <section className="py-16 bg-gradient-to-b from-background to-muted/30">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center">Krakenの始め方｜簡単3ステップ</h2>
        ...
        <section className="py-16 bg-gradient-to-b from-primary/10 to-background">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center text-primary">こんな人にKrakenがおすすめ</h2>
