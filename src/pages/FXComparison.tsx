  ...
  const comparisonData = [
    {
      ...
      features: "GMOクリック証券は、FX取引高で世界第1位を誇る業界最大手のFX会社です。スプレッドは業界最狭水準の0.2銭（米ドル/円）を提供し、取引コストを徹底的に抑えられます。高機能取引ツール「はっちゅう君FX」や「プラチナチャート」は、初めての方からプロトレーダーまで幅広く支持されています。スマホアプリ「GMOクリック FXneo」は直感的な操作性と豊富な情報配信で、外出先でも快適な取引環境を実現。24時間サポート体制も整っており、FX未経験の方でも安心して取引を始められます。",
      goodPoints: [
        "FX取引高世界第1位の圧倒的な実績と信頼性。多くのトレーダーに選ばれ続けている安心感",
        "スプレッドが業界最狭水準（米ドル/円0.2銭）でコストを最小限に抑えられる",
        "高機能ツール「はっちゅう君FX」「プラチナチャート」で本格的なテクニカル分析が可能",
        "24時間電話・メールサポート対応で、初めての方でも安心して取引できる環境",
