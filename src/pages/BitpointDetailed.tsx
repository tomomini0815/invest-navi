...
const BitpointDetailed = () => {
  const features = [
    {
      title: "SBIグループ傘下",
      description: "SBIグループ傘下の取引所として、信頼性と実績があります。",
    ...
    {
      title: "ステーキング報酬年率国内No.1(2025年3月11日BITPOINT社調べ)",
      description: "ステーキング報酬年率国内No.1(2025年3月11日BITPOINT社調べ)の実績があります。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "ゼロつみたて(スプレッド・手数料完全無料)",
      description: "ゼロつみたて(スプレッド・手数料完全無料)を提供しています。コストを抑えて取引が可能です。",
      icon: <Wallet className="h-6 w-6" />
    },
    {
      title: "入出金・取引手数料無料",
      description: "入出金・取引手数料が無料です。コストを抑えて取引が可能です。",
      icon: <Wallet className="h-6 w-6" />
    },
    {
      title: "ユニークなアルトコイン",
      description: "ユニークなアルトコインを取り扱っています。新しい暗号資産への投資機会を提供します。",
      icon: <Coins className="h-6 w-6" />
    },
    {
      title: "多様な暗号資産の取扱",
      description: "30種類の暗号資産を取り扱っています(2025年11月時点)。",
      icon: <Coins className="h-6 w-6" />
    }
  ];
  ...
  const steps = [
    {
      step: "STEP1",
      title: "メールアドレス・携帯番号登録",
      description: "公式サイトでメールアドレスと携帯番号を入力(ハイフン不要)し、届いたメールのURLからパスワードを設定してください。"
    },
    {
      step: "STEP2",
      title: "個人情報入力と本人確認",
      description: "基本情報を入力後、本人確認書類(運転免許証、マイナンバーカード、在留カード)をスマホで撮影し、顔写真も撮影します。"
    },
    {
      step: "STEP3",
      title: "審査完了後、取引開始",
      description: "審査完了メールが届いたら取引サイトへログインします。入金は「即時入金サービス(振込手数料無料)」または「銀行振込」から選択してください。"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="flex-grow">
        ...
        <section className="py-16 bg-gradient-to-b from-muted/30 to-background">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center">BITPOINTの特徴</h2>
        ...
        {/* BITPOINTの始め方｜簡単3ステップ */}
        <section className="py-16 bg-gradient-to-b from-background to-muted/30">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center">BITPOINTの始め方｜簡単3ステップ</h2>
        ...
        <section className="py-16 bg-gradient-to-b from-primary/10 to-background">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center text-primary">こんな人にBITPOINTがおすすめ</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  ...
                  <span className="font-medium text-gray-800">SBIグループの信頼性を重視する方</span>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="font-medium text-gray-800">ステーキング報酬を最大化したい方</span>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                ...
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="font-medium text-gray-800">ユニークなアルトコインに投資したい方</span>
                </div>
...
export default BitpointDetailed;