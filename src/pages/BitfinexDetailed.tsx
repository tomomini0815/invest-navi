...
const BitfinexDetailed = () => {
  const features = [
    ...
    {
      title: "LEOトークン保有で最大25%割引",
      description: "LEOトークンを保有することで取引手数料が最大25%割引になります。コストを抑えて取引が可能です。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "プロフェッショナル向け",
      description: "プロフェッショナル向けの取引所として知られています。高度な取引機能を提供しています。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "高機能な取引ツール",
    ...
    {
      title: "多様な暗号資産の取扱",
      description: "ビットコイン、イーサリアムなど、主要な暗号資産をはじめ、120以上の暗号通貨を取り扱っています。",
  ...
  const steps = [
    {
      step: "STEP1",
      title: "アカウント登録",
      description: "Bitfinex公式サイトで「サインアップ」をクリックし、メールアドレスと強力なパスワードを入力してください。登録確認メールが届くので、リンクをクリックして認証を完了します。その後、2要素認証（2FA）を有効にしてください。"
    },
    {
      step: "STEP2",
      title: "本人確認（KYC）",
      description: "ログイン後、KYC認証プロセスを開始します。電話番号、メールアドレス、居住地住所などの情報を入力し、本人確認書類（運転免許証、パスポート、マイナンバーカードなど）をアップロードします。2種類の有効な身分証明書が必要な場合があります。"
    },
    {
      step: "STEP3",
      title: "入金と取引開始",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="flex-grow">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <div className="mt-8">
              <Button asChild size="lg" className="px-8 py-6 text-lg hover:scale-105 transition-transform bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 shadow-lg">
                <a 
                  href="https://www.bitfinex.com/ja" 
                  target="_blank" 
        ...
        <section className="py-16 bg-gradient-to-b from-muted/30 to-background">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center">Bitfinexの特徴</h2>
        ...
        {/* Bitfinexの始め方｜簡単3ステップ */}
        <section className="py-16 bg-gradient-to-b from-background to-muted/30">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center">Bitfinexの始め方｜簡単3ステップ</h2>
        ...
        <section className="py-16 bg-gradient-to-b from-primary/10 to-background">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center text-primary">こんな人にBitfinexがおすすめ</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                ...
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="font-medium text-gray-800">プロフェッショナル向けの取引所を探している方</span>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
...
export default BitfinexDetailed;